...
# fontion pour publier l'evennement pour get toutes les incrption d'une classe en fontion de l'id de la classe 
def envent_get_all_inscription_of_classroom(classroom_id: int):
    payload = {
        "data": { "classroom_id": classroom_id }
    }
    return rpc_client.call("inscription.get_inscription_classroom", payload)
